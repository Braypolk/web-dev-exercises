...
/* harmony import */ var _dot__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dot */ "./src/js/dot.js");
...
function animateDot(dot, canvas) {
  ...
  var x = Math.sin(rand) * radius + canvas.width / 2;
  var y = Math.cos(rand) * radius + canvas.height / 2;
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(dot, {
...
addEventListener('load', function () {
  ...
  pixels.forEach(function (pixel, i) {
    var imgX = pixel.x + canvas.width / 2 - img.naturalWidth / 2;
    var imgY = pixel.y + canvas.height / 2 - img.naturalHeight / 2;
    var rand = Math.random() * Math.PI * 2;
    var startX = Math.sin(rand) * radius + canvas.width / 2;
    var startY = Math.cos(rand) * radius + canvas.height / 2;
    dots.push(new _dot__WEBPACK_IMPORTED_MODULE_1__["default"](startX, startY, pixel.r, pixel.g, pixel.b, imgX, imgY));
